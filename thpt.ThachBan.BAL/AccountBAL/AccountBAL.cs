...
namespace thpt.ThachBan.BAL.AccountBAL
{
    public class AccountBAL:IAccountBAL
    {
        ...
        {
            string fromEmail = "lehoangtrung038582@gmail.com"; // địa chỉ email của bạn
            string fromPassword = "lkgadeujyqlvhksq"; // mật khẩu email của bạn
